...
trap 'notify_discord "❌ **run_debug.sh** failed on $(hostname) (Job $SLURM_JOB_ID) at line $LINENO with exit code $?"' ERR
...
./batched_run_debug.sh

notify_discord "✅ **run_debug.sh** completed successfully (Job $SLURM_JOB_ID)"
